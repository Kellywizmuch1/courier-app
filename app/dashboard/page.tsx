...
export default function DashboardPage() {
  ...
  async function trackShipment(event?: FormEvent) {
    ...
    try {
      /*
       * IMPORTANT:
       * This is the same RPC used by the working
      ...
      if (!data) {
        console.log(
          "DASHBOARD TRACKING: NO DATA RETURNED"
        );

        setTrackingError(
          "No shipment data was returned for this tracking number."
        );
      ...
      if (!result.shipment) {
        console.log(
          "DASHBOARD TRACKING: SHIPMENT IS NULL"
        );
        ...
        <div className="mb-10">
          ...
          {!trackingLoading &&
            ...
            trackingError && (
              ...
              <div className="mt-5 bg-red-50 border border-red-200 rounded-3xl p-8">
