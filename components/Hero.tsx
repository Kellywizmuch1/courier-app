        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              ...
              <Link
                href="/track"
                className="inline-flex items-center gap-3 bg-white/10 hover:bg-white/15 border border-white/20 text-white px-7 py-4 rounded-xl font-extrabold backdrop-blur-md transition-all duration-300 hover:-translate-y-1"
              >
                <Package size={20} />
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative bg-white/10 backdrop-blur-xl border border-white/15 rounded-[2rem] p-8 shadow-2xl">
              ...
              <div className="space-y-7">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="w-11 h-11 rounded-full bg-green-500/20 border border-green-400/30 flex items-center justify-center">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="w-11 h-11 rounded-full bg-orange-500/20 border border-orange-400/30 flex items-center justify-center">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="w-11 h-11 rounded-full bg-blue-500/20 border border-blue-400/30 flex items-center justify-center">
            ...
            <div className="absolute -bottom-8 -left-10 bg-white rounded-2xl shadow-2xl p-5 flex items-center gap-4">
              ...
              <div className="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center">
                <ShieldCheck className="text-blue-900" size={25} />
              </div>
